...
namespace enemy
{
    /// <summary>Move state specific to <see cref="EnemySlime"/>.</summary>
    public class EnemySlimeMoveState : EnemyState
    {
        public EnemySlimeMoveState(Enemy enemy, StateMachine stateMachine, string animBoolName)
