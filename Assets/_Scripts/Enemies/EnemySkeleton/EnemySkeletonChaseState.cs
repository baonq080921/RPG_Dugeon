...
{
    /// <summary>
    /// Chase state specific to <see cref="EnemySkeleton"/>.
    /// Moves toward the player and jumps over obstacles. Transitions to attack when in range.
    /// </summary>
    public class EnemySkeletonChaseState : EnemyState
    {
        private float _jumpCooldownTimer;
        private const float JumpCooldown = 0.5f;

        public EnemySkeletonChaseState(Enemy enemy, StateMachine stateMachine, string animBoolName)
