...
namespace player
{
    ...
    /// Set <see cref="SkillObject_Base"/>'s enemy layer in the Inspector to control what the projectile can hit
    ...
    /// </summary>
    public abstract class SkillProjectileBase : SkillObject_Base
    {
