...
namespace Quest
{
    ...
    /// Hooks into the existing <see cref="OnEnemyDiedEvent"/> on the EventBus.
    /// </summary>
    ...
    public class KillQuestData : QuestData
    {
        ...
        private EventBinding<OnEnemyDiedEvent> _binding;
        ...
        {
            _binding = new EventBinding<OnEnemyDiedEvent>(OnEnemyDied);
            EventBus<OnEnemyDiedEvent>.Register(_binding);
        }
        ...
        {
            if (_binding != null)
                EventBus<OnEnemyDiedEvent>.Deregister(_binding);
        }
